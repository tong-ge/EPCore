...
import cn.gtcommunity.epimorphism.api.capability.impl.AlgaeFarmLogic;
...
public class EPMetaTileEntityAlgaeFarm extends MultiblockWithDisplayBase implements IDataInfoProvider, IWorkable {
    private final AlgaeFarmLogic logic;
    protected IMultipleTankHandler inputFluidInventory;
    protected ItemHandlerList itemImportInventory;
    protected IItemHandler outputItemInventory;
    public EPMetaTileEntityAlgaeFarm(ResourceLocation metaTileEntityId) {
    ...
    protected IBlockState getCasingState() {
        return EPMetablocks.EP_MULTIBLOCK_CASING.getState(EPBlockMultiblockCasing.CasingType.FARM_CASING);
    }
    @Nonnull
    @Override
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('X', EPTraceabilityPredicate.EP_MACHINE_CASINGS.get())
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return EPTextures.FARM_CASING;
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new EPMetaTileEntityAlgaeFarm(metaTileEntityId);
    }
    ...
    protected ICubeRenderer getFrontOverlay() {
        return EPTextures.ALGAE_FARM_OVERLAY;
    }
