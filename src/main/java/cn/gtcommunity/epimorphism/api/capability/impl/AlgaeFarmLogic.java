...
import cn.gtcommunity.epimorphism.common.metatileentities.multiblock.EPMetaTileEntityAlgaeFarm;
...
public class AlgaeFarmLogic {
    ...
    private final EPMetaTileEntityAlgaeFarm metaTileEntity;
    ...
    public AlgaeFarmLogic(EPMetaTileEntityAlgaeFarm metaTileEntity, int minEnergyTier) {
    ...
    public void update() {
       ...
       if (!isInventoryFull) {
            ...
            //褐藻
            if(metaTileEntity.fillChest(EPMetaItems.BROWN_ALGA.getStackForm(x*Math.max(0,(CasingTier-2))), true))
            {
                metaTileEntity.fillChest(EPMetaItems.BROWN_ALGA.getStackForm(x*Math.max(0,(CasingTier-2))), false);
            }
            else {
            ...
            //普通
            if(metaTileEntity.fillChest(EPMetaItems.ORDINARY_ALGAE.getStackForm(x*CasingTier), true))
            {
                metaTileEntity.fillChest(EPMetaItems.ORDINARY_ALGAE.getStackForm(x*CasingTier), false);
            }
            else {
                isInventoryFull = true;
                setActive(false);
            ...
            //绿藻
            if(metaTileEntity.fillChest(EPMetaItems.GREEN_ALGA.getStackForm(x*CasingTier), true))
            {
                metaTileEntity.fillChest(EPMetaItems.GREEN_ALGA.getStackForm(x*CasingTier), false);
            }
            else {
                isInventoryFull = true;
                setActive(false);
            ...
            //金藻
            if(metaTileEntity.fillChest(EPMetaItems.CHRYSOPHYCEAE.getStackForm(x*Math.max(0,(CasingTier-4))), true))
            {
                metaTileEntity.fillChest(EPMetaItems.CHRYSOPHYCEAE.getStackForm(x*Math.max(0,(CasingTier-4))), false);
            }
            else {
                isInventoryFull = true;
                setActive(false);
            ...
            //红藻
            if(metaTileEntity.fillChest(EPMetaItems.RED_ALGA.getStackForm(x*Math.max(0,(CasingTier-5))/2), true))
            {
                metaTileEntity.fillChest(EPMetaItems.RED_ALGA.getStackForm(x*Math.max(0,(CasingTier-5))/2), false);
            }
            else {
                isInventoryFull = true;
                setActive(false);
            ...
            //T藻
        //    if(metaTileEntity.fillChest(EPMetaItems.T_ALGAE.getStackForm(x*Math.min(0,(CasingTier-4))), true))
         //   {
         //       metaTileEntity.fillChest(EPMetaItems.T_ALGAE.getStackForm(x*Math.min(0,(CasingTier-4))), false);
         //   }
        //    else {
         //       isInventoryFull = true;
         //       setActive(false);
